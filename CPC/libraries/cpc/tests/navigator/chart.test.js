...
describe ('Connector Polygons', () => {
    ...
    test ('Get/set showConnectorPolygons() ', () => {

        initializeDomWithSvg()
        const myChart = new navigator.Chart()

        myChart.showConnectorPolygons(true)
        expect( myChart.showConnectorPolygons() ).toBeTruthy()

        myChart.showConnectorPolygons(false)
        expect( myChart.showConnectorPolygons() ).toBeFalsy()

    })

    test ('When set to be visible, all connector polygons should become visible', () => {

        initializeDomWithSvg()
        const myChart = new navigator.Chart()

        // Toggle connector polygons visibility on
        myChart.showConnectorPolygons(true).update()
        expect(  getVisibilityStatusesOfConnectorPolygonsInAllCategories() ).toEqual( [true, true, true] )


        // Toggle connector polygons visibility off
        myChart.showConnectorPolygons(false).update()
        expect(  getVisibilityStatusesOfConnectorPolygonsInAllCategories() ).toEqual( [false, false, false] )



        // Helper Function(s)

        function getVisibilityStatusesOfConnectorPolygonsInAllCategories() {
            ...
            return visibilityStatusesOfAllConnectorPolygons
        }
