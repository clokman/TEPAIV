...
describe( 'LISTEN AND RECORD CLICKS', () => {
    ...
    // {  // PREPARATION //  // Clear DOM and create elements in it clearDomAndCreateSampleContainerWithTwoRectangles()
    // document.clickListenerAdded = false  clearConsoleHistory()  jest.spyOn(EventTarget.prototype,
    // 'addEventListener')   })
