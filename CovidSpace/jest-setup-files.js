...
// Internal ////////////////////////////////////////////////////////////////////////////////////////////////
global.agent = require( './modules/agent' )
global.obstacle = require( './modules/obstacle' )



// External ////////////////////////////////////////////////////////////////////////////////////////////////

global.$ = require( './modules/external/jquery-3.1.1.min' ) // Also an UMD dependency
global._ = require( './modules/external/lodash' )

global.d3 = {
    ...require( './modules/external/d3/d3' ),
    ...require( './modules/external/d3/d3-array' )
}
...
global.cpcDefaults = require( '../CPC/cpcDefaults' )
